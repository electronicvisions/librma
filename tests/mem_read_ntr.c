...
//   }  
  ...
  while (bytes > 0 )
  {
    ...
    if (cmd_type==0)
      rc=rma2_post_get_qw(port, handle, recv_nla_buffer_region, recv_offset, bytes_to_send, send_nla,RMA2_RESPONDER_NOTIFICATION | RMA2_COMPLETER_NOTIFICATION|RMA2_REQUESTER_NOTIFICATION,RMA2_CMD_NTR);
    else if (cmd_type==1)
      rc=rma2_post_get_bt(port, handle, recv_nla_buffer_region, recv_offset, bytes_to_send, send_nla,RMA2_RESPONDER_NOTIFICATION | RMA2_COMPLETER_NOTIFICATION|RMA2_REQUESTER_NOTIFICATION,RMA2_CMD_NTR);
    else
    {
